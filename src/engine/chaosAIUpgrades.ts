...
// Остаются только специальные: Вихрь (vortex) и Рикошет (ricochet)

// Главная функция — применяет улучшения ИИ к ходу Stockfish.
// В mechanics-v3 стандартные улучшения (berserk/sniper/guard) отключены — функция прозрачна.
export function applyAIUpgrades(chess: Chess, stockfishMove: string, aiUpgrades: AIUpgrade[]): string {
  // TODO: mechanics-v3 — логика berserk/sniper/guard закомментирована
  ...
  // }
  void chess; void aiUpgrades;
  return stockfishMove;
}

// TODO: mechanics-v3 — функции стандартных улучшений AI закомментированы
...
//     m.piece === move.piece && m.color === 'b' && m.captured &&
...
// TODO: mechanics-v3 — вспомогательные функции стандартных улучшений закомментированы
